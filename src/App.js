...
export default function App() {
	...
	const handleLogin = async (e) => {
		...
		try {
			const response = await fetch(
				"https://bookmarks-backend.onrender.com/login",
				{
					method: "POST",
					headers: {
	...
	const createBookmark = async (e) => {
		...
		try {
			const response = await fetch(
				"https://bookmarks-backend.onrender.com/bookmarks",
				{
					method: "POST",
					headers: {
						"Content-Type": "application/json",
			...
			const addBookmark = await fetch(
				"https://bookmarks-backend.onrender.com/users/addBookmarkToUser",
				{
					method: "POST",
					headers: {
						"Content-Type": "application/json",
	...
	const getBookmarks = async () => {
		try {
			const response = await fetch(
				`https://bookmarks-backend.onrender.com/users/${window.localStorage.getItem(
					"username",
				)}`,
				{
					method: "GET",
	...
	const updateBookmark = async (data, id) => {
		try {
			const response = await fetch(
				`https://bookmarks-backend.onrender.com/bookmarks/${id}`,
				{
					method: "PUT",
					headers: {
						"Content-Type": "application/json",
									...
									return (
										<section>
											<div className="each-bookmark">
												<a href={bookmark.url} target="_target">
													{bookmark.title}
												</a>
												{"  "}
