            ...
            <div className="bg-modal">
                <div className="modal-container">
                    <form className="modal-form" onSubmit={createUser}>
                        ...
                        <input className="edit" type="text" id="username" placeholder="username" onChange={createChange} value={createForm.username} /> <br/>
                        </label>
                        <br />
                        <label for="passwords">Password: {" "}
                        <input className="edit" type="password" id="password" placeholder="password" onChange={createChange} value={createForm.password} /> <br/>
                        </label>
                        <br />
